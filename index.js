...
function setDateDetails(date, isoString) {
  ...
  if (!typeof newDate.getTime() === "number") {
...
function addDays(date, days) {
  ...
  return { currentDate, days, newDate };
}
...
function getAge(birthDate) {
  ...
  let ageDiff = newDate.getFullYear() - birthDate.getFullYear();
  if (
    newDate.getMonth() < birthDate.getMonth() ||
    (newDate.getMonth() === birthDate.getMonth() &&
      newDate.getDate() < birthDate.getDate())
  ) {
    ageDiff--;
  }

  return { birthDate, ageDiff };
}
...
function getDaysDifference(startDate, endDate) {
  ...
  const startDate1 = startDate.getTime();
  const endDate1 = endDate.getTime();
  const daysDifference = (endDate1 - startDate1) / (1000 * 60 * 60 * 24);
  return {
    startDate1,
    endDate1,
    daysDifference,
